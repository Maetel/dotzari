...
- [인터랙티브 디자인 탐색 5안](./design-explorations/index.html)
- [디자인 탐색 설명](./design-explorations/README.md)

현재 다섯 안은 비교와 논의를 위한 비규범적 자료다. 선택하거나 결합할 방향이 합의되기 전에는
특정 안의 시각 스타일이나 화면 구조를 구현 요구사항으로 간주하지 않는다. 합의된 디자인 결정은
관련 본문과 결정 기록에 별도로 반영한다.
