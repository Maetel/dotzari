...
- [2차 통합 디자인 탐색 3안](./design-explorations/index.html)
- [1차 디자인 탐색 5안](./design-explorations/five-directions.html)
- [디자인 탐색 설명](./design-explorations/README.md)

현재 시안은 비교와 논의를 위한 비규범적 자료다. 2차 탐색은 Slide Studio와 Concept Atlas를
결합한다는 방향만 확정했고, 세 시안 중 어떤 정보 구조와 시각 스타일을 제품 기준으로 삼을지는
아직 결정하지 않았다. 선택하거나 다시 결합할 방향이 합의되면 관련 본문과 결정 기록에 반영한다.
